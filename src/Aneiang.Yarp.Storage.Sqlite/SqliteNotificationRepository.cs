...
public sealed class SqliteNotificationRepository : INotificationRepository
{
    ...
    {
        await SqliteRepositoryInitializer.EnsureTableExistsAsync(_connections, "notification_settings", ct);
        await SqliteRepositoryInitializer.EnsureTableExistsAsync(_connections, "notification_history", ct);
        _initialized = true;
