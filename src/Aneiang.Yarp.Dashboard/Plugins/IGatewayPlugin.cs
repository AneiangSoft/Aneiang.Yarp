...
public class CircuitBreakerPlugin : IGatewayPlugin
{
    ...
    {
        proxyPipeline.UseMiddleware<Aneiang.Yarp.Dashboard.Middleware.CircuitBreakerMiddleware>();
    }
}
...
public class RequestRetryPlugin : IGatewayPlugin
{
    ...
    public void ConfigureProxyPipeline(IReverseProxyApplicationBuilder proxyPipeline)
    {
        proxyPipeline.UseMiddleware<Aneiang.Yarp.Dashboard.Middleware.RequestRetryMiddleware>();
    }
}
...
public class WafPlugin : IGatewayPlugin
{
    ...
    public void ConfigureMiddleware(IApplicationBuilder app)
    {
        app.UseMiddleware<Aneiang.Yarp.Dashboard.Middleware.WafMiddleware>();
    }
