...
public static class DashboardI18n
{
    ...
    public static readonly Dictionary<string, string> ZhCN = new()
    {
        ...
        ["webhook.addUrl"] = "添加地址",
        ["webhook.secret"] = "签名密钥",
        ["webhook.secret.placeholder"] = "可选，用于 HMAC-SHA256 签名验证",
        ["webhook.secret.help"] = "设置后将在请求头中携带 X-Webhook-Signature",
        ["webhook.save"] = "保存设置",
        ["webhook.saving"] = "保存中...",
        ...
        ["webhook.platform.feishu"] = "飞书机器人",
        ["webhook.platform.wecom"] = "企业微信机器人",
        ["webhook.platform.generic"] = "自定义 Webhook",
        ["webhook.dingtalk.help"] = "URL 格式：https://oapi.dingtalk.com/robot/send?access_token=你的Token",
        ["webhook.dingtalk.secret.help"] = "钉钉机器人加签密钥（安全设置 → 加签），设置后将自动在 URL 中计算签名",
        ["webhook.feishu.help"] = "URL 格式：https://open.feishu.cn/open-apis/bot/v2/hook/你的Token",
        ["webhook.feishu.secret.help"] = "飞书机器人签名密钥（可选）",
        ["webhook.wecom.help"] = "URL 格式：https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=你的Key",
        ["webhook.wecom.secret.help"] = "企业微信暂不需要单独的签名密钥",
    ...
    public static readonly Dictionary<string, string> EnUS = new()
    {
        ...
        ["webhook.secret.placeholder"] = "Optional, for HMAC-SHA256 signature verification",
        ["webhook.secret.help"] = "X-Webhook-Signature header will be included when set",
        ...
        ["webhook.platform.feishu"] = "Feishu Robot",
        ["webhook.platform.wecom"] = "WeCom Robot",
        ...
        ["webhook.dingtalk.secret.help"] = "DingTalk robot signing secret (Security Settings → Sign). Signature will be auto-calculated in URL when set.",
        ["webhook.feishu.help"] = "URL format: https://open.feishu.cn/open-apis/bot/v2/hook/YOUR_TOKEN",
        ["webhook.feishu.secret.help"] = "Feishu robot signing secret (optional)",
        ["webhook.wecom.help"] = "URL format: https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=YOUR_KEY",
        ["webhook.wecom.secret.help"] = "WeCom does not require a separate signing secret",
